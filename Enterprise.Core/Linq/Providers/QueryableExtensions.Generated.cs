...
namespace Enterprise.Core.Linq.Providers
{
    ...
    public static partial class QueryableExtensions
    {
        ...
        public static Task<List<object>> ToListAsync(this IQueryable source)
        {
            ...
            return source.AsAsyncEnumerable().ToListAsync<object>();
        }
        ...
        /// <paramref name="source" /> doesn't implement <see cref="IAsyncQueryProvider" />.
        /// </exception>
        ...
        {
            var candidates = typeof(Queryable).GetMember(methodName, MemberTypes.Method, BindingFlags.Static | BindingFlags.Public);
