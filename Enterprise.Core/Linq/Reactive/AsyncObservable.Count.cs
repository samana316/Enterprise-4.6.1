...
namespace Enterprise.Core.Linq.Reactive
{
    ...
    {
        public static IAsyncObservable<int> Count<TSource>(
            this IAsyncObservable<TSource> source)
        {
            Check.NotNull(source, "source");

            return new CountAsyncObservable<TSource>(source, null);
        }
            ...
            Func<TSource, bool> predicate)
        {
            ...
            return new CountAsyncObservable<TSource>(source, predicate);
        }

        private sealed class CountAsyncObservable<TSource> : AsyncObservableBase<int>
        {
            private readonly IAsyncObservable<TSource> source;

            private readonly Func<TSource, bool> predicate;

            public CountAsyncObservable(
